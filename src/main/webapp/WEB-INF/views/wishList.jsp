...
<%--                <c:forEach items="${productInWishList}" var="productToBuy">--%>
<%--                    <tr>--%>
<%--                        <td><a href="${cp}/showProductDetails?pid=${productToBuy.pid}">--%>
<%--                            <img style="height: 50%;" src="${cp}/img/${productToBuy.imgUrl}" alt="">--%>
<%--                        </a></td>--%>
<%--                        <td>${productToBuy.name}</td>--%>
<%--                        <td>${productToBuy.price}</td>--%>
<%--                        <td>${productToBuy.quantity}</td>--%>
<%--                        <td>--%>
<%--                            <button class="btn btn-primary" onclick="deleteWishList(${productToBuy.pid})">Delete</button>--%>
<%--                            <button class="btn btn-primary" onclick="moveToCart(${productToBuy.pid})">MoveToCart</button>--%>
<%--                        </td>--%>
<%--                    </tr>--%>
<%--                </c:forEach>--%>
<%--            </table>--%>
...
<%--                <button type="button" class="btn btn-danger btn-lg col-lg-4 col-md-4 col-sm-4">Confirm Checkout</button>--%>
<%--            </div>--%>
<%--        </div>--%>
<%--    </div>--%>
<%--</div>--%>
